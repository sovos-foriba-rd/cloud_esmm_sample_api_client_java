...
public class GetReportListFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public GetReportListFaultMessage(String message, ProcessingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetReportListFaultMessage(String message, ProcessingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
