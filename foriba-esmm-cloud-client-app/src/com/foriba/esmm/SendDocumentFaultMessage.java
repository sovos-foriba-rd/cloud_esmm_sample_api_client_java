...
public class SendDocumentFaultMessage
    extends Exception
{
     ...
     * @param message
     */
    public SendDocumentFaultMessage(String message, ProcessingFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public SendDocumentFaultMessage(String message, ProcessingFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
